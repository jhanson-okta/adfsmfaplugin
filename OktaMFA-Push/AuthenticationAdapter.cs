...
namespace OktaMFAPush
{
        ...
        
    {
        public IAdapterPresentation BeginAuthentication(System.Security.Claims.Claim identityClaim, System.Net.HttpListenerRequest request, IAuthenticationContext context)
        {
            ...
            claimarray[0] = identityClaim;
  
            ProofData proof = new ProofData();
            proof.Properties["pin"] = "";
            proof.Properties["pollingEndpoint"] = pollingEndpoint;
            proof.Properties["upn"] = userID;
           
            return new AdapterPresentation(message, upn, isPermanentFailure, pollingEndpoint, context, proof, request, out claimarray);*/


            return new AdapterPresentation(message, upn, isPermanentFailure, pollingEndpoint, messageVal, oktaTenant);
        }
